...
\cmidrule(lr){2-4} \cmidrule(lr){5-7}
  ...
  & Seconds$\downarrow$ & Millions $\downarrow$ \\
\midrule
UMambaBot         & \underline{6.207} & \underline{0.992} & 38.623 
                  & \underline{6.171} & \underline{0.992} & 38.545 & \underline{0.077} & 141.6 \\
SegResNet         & 6.326 & 0.991 & \underline{38.783} 
                  & 6.494 & 0.991 & 38.572 & \textbf{0.056} & 214.1 \\
SwinUNETR         & 6.235 & \underline{0.992} & 38.942 
                  & 6.229 & \underline{0.992} & \underline{38.933} & 0.087 & \textbf{120.1} \\
TimeResNet (Our)  & \textbf{5.399} & \textbf{0.996} & \textbf{40.017} 
                  & \textbf{5.436} & \textbf{0.996} & \textbf{39.776} & 0.209 & \underline{124.7} \\
\bottomrule
\end{tabular}
\vspace{0.2cm}
